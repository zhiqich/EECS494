...
public class SceneTransitionController : MonoBehaviour {
    ...
    public static bool RequestSceneTransition(string scene_name, float duration_sec, SceneTransitionCallback callback, Texture fade_shape, AnimationCurve ease_curve=null, int special = 0, float max_fade_image_size_factor = 4.0f)
    {
        ...
        singleton.StartCoroutine(_TransitionScene(scene_name, duration_sec, callback, ease_curve, special));
        return true;
    }
    ...
    static IEnumerator _TransitionScene(string scene_name, float duration_sec, SceneTransitionCallback callback, AnimationCurve ease_curve = null, int special = 0)
    {
        ...
        if (special == 2)
        {
            ...
            //Destroy(GameObject.Find("GameAnalytics"));
        }
